...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$depardo_description = get_bloginfo( 'description', 'display' );
			if ( $depardo_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $depardo_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
